...
export class MaintenanceController {
  ...
  @Delete('schedules/:id') @Roles('ADMINISTRATOR', 'OFFICER') removeSchedule(@Param('id') id: string) { return this.svc.removeSchedule(id); }
  ...
  @Delete('logs/:id') @Roles('ADMINISTRATOR', 'OFFICER', 'ENGINEER') removeLog(@Param('id') id: string) { return this.svc.removeLog(id); }
}
